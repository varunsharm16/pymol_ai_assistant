...
def _call_llm(prompt: str) -> dict:
    ...
    system_msg = (
        ...
        ' clear measurements -> {"name":"clear_measurements","arguments":{}}\n'
        ...
        ' measure distance between ligand in chain B and all ASP in chain B -> {"name":"measure_distance","arguments":{"source":{"kind":"ligand","chain":"B"},"target":{"kind":"residue","residue":"ASP","chain":"B","all_matches":true}}}\n'
